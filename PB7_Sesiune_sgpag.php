        ...
        <table cellpadding=5 cellspacing=0 border=0 width="75%">
            <form method="post" action="PB7_Sesiune_sgpag.php">
                <tr><td> <font face="Courier" size="2">
                            <b>Nume:</b> </td> <td>
                                <input name="nume" size=20 maxlength=50></td> </tr>
                <tr> <td> <b>Prenume:</b> </td> <td>
                                <input name="prenume" size=20 maxlength=50></td> </tr>
                <tr> <td> <b>Nota la matematica:</b></td> <td>
                                <input name="nota1" size=20 maxlength=2></td> </tr>
                <tr> <td> <b>Nota romana:</b></td><td>
                                <input name="nota2" size=20 maxlength=20></td> </tr>
                <tr> <td width="142">
                            <input type="submit" name="Inregistrare" value="Inregistrare"></td></tr>
            </form>
        </table>
        <?php
        if (isset($_POST['Inregistrare'])){
