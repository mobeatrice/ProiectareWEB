...
{ // Afisare inregistrari pe ecran
    if ($result->num_rows > 0)
    {
        ...
        // antetul tabelului
        echo
        "<tr><th>ID</th><th>Nume</th><th>Prenume</th><th>an</th><th>grupa</th><th></th><th></th></t
r>";
        ...
        while ($row = $result->fetch_object())
        {
            ...
            echo "<td><a href='update.php?id=" . $row->idstudent .
                "'>Modificare</a></td>";
            echo "<td><a href='stergere.php?id=" . $row->idstudent .
                "'>Stergere</a></td>";
            echo "</tr>";
        }
